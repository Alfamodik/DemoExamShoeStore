...
public partial class ShoeStore2Context : DbContext
{
    public ShoeStore2Context()
    {
    }

    public ShoeStore2Context(DbContextOptions<ShoeStore2Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=localhost;user=root;password=root;database=shoe_store2", ServerVersion.Parse("8.0.41-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CartItem>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductArticle, "product_article");

            entity.HasIndex(e => new { e.UserId, e.ProductArticle }, "uq_cart_user_product").IsUnique();
            ...
            entity.HasOne(d => d.ProductArticleNavigation).WithMany(p => p.CartItems)
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.Status)
                ...
                .HasColumnType("enum('Новый','Завершен','Отменен')")
